...
bool DrawingPageLGN::trySetDesignPressure(const std::wstring& sourceStr, ValuesCheker::Type checkType)
{
	if (sourceStr == L"атм.") {
		designPressure = L"atm.";
		return true;
	}
	return DrawingPage::trySetDesignPressure(sourceStr, checkType);
}

bool DrawingPageLGN::trySetFileName(const std::wstring& sourceStr, ValuesCheker::Type checkType)
{
	...
	return DrawingPage::trySetFileName(newFileNameStr, checkType);
}

bool DrawingPageLGN::trySetWeldInspection(const std::wstring& sourceStr, ValuesCheker::Type checkType)
{
	...
	return DrawingPage::trySetWeldInspection(sourceStr, checkType);
}

bool DrawingPageLGN::trySetStressCalculation(const std::wstring& sourceStr, ValuesCheker::Type checkType)
{
	...
	return DrawingPage::trySetStressCalculation(sourceStr, checkType);
}

bool DrawingPageLGN::trySetOperatingTemperature(const std::wstring& sourceStr, ValuesCheker::Type checkType)
{
	//std::wstring checkParametrMessage{ L"Проверьте параметр в чертеже" };
	//if (sourceStr == checkParametrMessage)
	//{
	//	operatingTemperature = checkParametrMessage;
	//	return true;
	//}
	return DrawingPage::trySetOperatingTemperature(sourceStr, checkType);
}
