...
DrawingPageLGN::DrawingPageLGN()
{
	...
	lineNumberPattern.assign(LR"(\d{3}-[A-Z0-9]{1,4}-\d{4}-[A-Z0-9]{9,11}|Protective duct drain\/Слив защитного желоба №\d{2}(_|-)\d{2,3}(_|-)\d{2})");
	stressCalculationPattern.assign(LR"(NO\/НЕТ|YES\/ДА)");
	isometricDrawingPattern.assign(LR"(\d{3}-[A-Z0-9]{1,4}-\d{4}-[A-Z0-9]{9,11}|Protective duct drain\/Слив защитного желоба №\d{2}(_|-)\d{2,3}(_|-)\d{2})");
